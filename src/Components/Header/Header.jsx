          ...
          <div className="header__top">
            ...
            {user ? (
              <div className="header__user">
                ...
                >
                  <i className="far fa-user mr-1" /> {user.name}
                </div>
                <div
            ...
            <ul>
              <li>
                <NavLink
                  to="/"
                  className={(navData) =>
                    navData.isActive ? "text-black" : "text-white"
                  }
          ...
          <div className="header__mobile__content">
            ...
            <div className="header__mobile__right">
              ...
              >
                ...
                <NavLink className="dropdown-item" to="/cinema_system">
                  {t("cinema")}
                </NavLink>
